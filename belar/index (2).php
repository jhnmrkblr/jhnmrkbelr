        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-md-7 py-4">
                    ...
                    <p class="text-muted">Belar Hotel Booking System is a web-based platform designed to make hotel reservations easier, faster, and more convenient for both guests and administrators. The system provides a user-friendly interface where customers can browse available rooms, check rates, and make secure bookings in just a few clicks.</p>
                </div>
    ...
    <div class="navbar navbar-dark bg-dark box-shadow">
        <div class="container d-flex justify-content-between">
            <a href="#" class="navbar-brand d-flex align-items-center">
                ...
                <strong>Belar Hotel Booking</strong>
            </a>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted"><?php echo formatPeso(250); ?> / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted"><?php echo formatPeso(180); ?> / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted"><?php echo formatPeso(130); ?> / night</small>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <form role="form" autocomplete="off" method="post" id="multiStepRsvnForm">
                            ...
                            <div class="rsvnTab">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9 roomPriceTxt"><?php echo formatPeso(235.75); ?></div>
                                </div>
