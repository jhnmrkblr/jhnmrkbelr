...
public function toggle_maintenance()
{
    ...
    $is_checked = $this->input->post('maintenance_mode') ? true : false;

    $data = ['maintenance_mode' => $is_checked];
    file_put_contents($file, json_encode($data));

    $msg = $is_checked ? 'Maintenance mode enabled.' : 'Maintenance mode disabled.';
